...
function renderWeatherInfo(weatherInfo) {
    ...
    const maxTemp = document.querySelector("[data-max]");
    const sunrise = document.querySelector("[data-rise]");
    const sunset = document.querySelector("[data-set]");
    ...
    maxTemp.innerHTML = `${weatherInfo?.main?.temp_max}`;

    let sunRiseTime = parseInt(weatherInfo?.sys?.sunrise);
    ...
    let sunSetTime = parseInt(weatherInfo?.sys?.sunset);
